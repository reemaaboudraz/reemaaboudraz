...
<!--
**reemaaboudraz/reemaaboudraz** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
I'm a Software Engineering student in Canada passionate about building meaningful innovations that blend technology, user experience, and business impact.

I’m currently working on a campus guide app where I lead an 11-member team in building a user-centered mobile solution for easier campus navigation.
...
## Skills
- **Languages:** Python, SQL, Java, JavaScript, PHP, HTML, CSS, C++, C#, TypeScript, Rust
- **Technologies:** React, React Native, Firebase, Node.js, .NET, MongoDB, Laravel, Git, GitHub, Jira, Docker
- **Tools:** Excel, PowerPoint, PowerBI, Metabase, Streamlit
